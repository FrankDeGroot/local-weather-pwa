...
<main>
      ...
      <div class="uk-container uk-container-xsmall">
        <div class="uk-margin-small-top">
          ...
          <ul class="uk-switcher uk-margin-small-top">
              ...
              <div class="uk-grid-large uk-margin-small-top" uk-grid>
                <div class="uk-width-1-2 uk-text-right">
                  <div class="uk-heading-small uk-margin-remove-bottom">
                    {weather.daily.data[0].temperatureMin.toFixed(0)}℃
                  </div>
                  <div
                    class="uk-text-meta uk-padding uk-padding-remove-vertical
                    uk-text-uppercase">
                    low
                  </div>
                </div>
                <div class="uk-width-1-2 uk-text-left">
                  <div class="uk-heading-small uk-margin-remove-bottom">
                    {weather.daily.data[0].temperatureMax.toFixed(0)}℃
                  </div>
                  <div
                    class="uk-text-meta uk-padding uk-padding-remove-vertical
                    uk-text-uppercase">
            ...
            <li>
              <div
                class="uk-grid-small uk-child-width-1-1 uk-text-center slim"
                uk-grid>
                <Weather condition="{weather.daily.icon}" />
                <div class="uk-text-lead uk-padding-remove">
                ...
                <ul uk-accordion class="accordion uk-text-left">
                  ...
                  {#each days as dayOfWeek, i}
                    <li>
                      <a class="uk-accordion-title" href="#title">
                        <div class="uk-grid-collapse" uk-grid>
                          ...
                          <div class="uk-width-1-5">
                            <div>
                              <Weather
                                {mini}
                                condition="{weather.daily.data[i].icon}" />
                            </div>
                          </div>
                          <div class="uk-width-1-4">
                            <div>
                              {weather.daily.data[i].temperatureMax.toFixed(0)}℃
                            </div>
                          </div>
                          <div class="uk-width-1-5 text-deemphasize">
                            <div>
                              {weather.daily.data[i].temperatureMin.toFixed(0)}℃
                            </div>
                          </div>
                        </div>
                      </a>
  ...
  {:else}
    <p class="uk-text-center uk-margin-large-top">
      <span class="uk-margin-large-top" uk-spinner="ratio: 5"></span>
    </p>
  {/if}
